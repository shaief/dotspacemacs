...
(custom-set-variables
 ...
 '(org-capture-templates (quote (("ort/checkitem" "Org Repo Checklist Item" checkitem (file+headline (ort/todo-file) "Checklist")) ("ort/todo" "Org Repo Todo" entry (file+headline (ort/todo-file) "Todos") "* TODO  %?			%T
 %i
 Link: %l
"))))
